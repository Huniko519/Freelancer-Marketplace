	   ...
	   <div class="row">
		<div class="col-lg-12">
         ...
         <div class="headline">
		  ...
		  <a href="<?=$this->siteUrl()?>/<?=$this->client_url()?>/files"><?=$this->lang('go_back')?></a>
		 </div>	

         <div class="add-box">
           <form method="post" action="<?=$this->siteUrl()?>/<?=$this->client_url()?>/addfiles" enctype="multipart/form-data">
